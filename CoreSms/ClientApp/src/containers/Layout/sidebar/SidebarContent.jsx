    ...
    return (
      <div className="sidebar__content">
        <ul className="sidebar__block">
          <SidebarCategory title="Target" icon="users">
            <SidebarLink title="People" route="/peopleView" onClick={this.hideSidebar} />
            <SidebarLink title="Contact" route="/viewContact" onClick={this.hideSidebar} />
            <SidebarLink title="File Upload" route="/fileUpload" onClick={this.hideSidebar} />
          </SidebarCategory>
        </ul>

        <ul className="sidebar__block">
          <SidebarCategory title="Communication" icon="phone">
            <SidebarLink title="Overview" route="/templateCreate" onClick={this.hideSidebar} />
            <SidebarLink title="SMS" route="/viewContact" onClick={this.hideSidebar} />
          </SidebarCategory>
        </ul>
