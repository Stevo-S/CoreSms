      ...
      <div className="sidebar__content">
        <ul className="sidebar__block">
          ...
          <SidebarCategory title="Target" icon="users">
            <SidebarLink title="Contacts" route="/target/people" onClick={this.hideSidebar} />
            <SidebarLink title="Import Contact" route="/target/import" onClick={this.hideSidebar} />
            <SidebarLink title="Tags" route="/ui/buttons" onClick={this.hideSidebar} />
          ...
          <ul className="sidebar__block">
            ...
            <SidebarLink title="Analysis" icon="home" route="/dashboard_default" onClick={this.hideSidebar} />
            {/* <SidebarLink
